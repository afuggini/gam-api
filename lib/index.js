...
var default_1 = /** @class */ (function () {
    function default_1(config) {
        var networkCode = config.networkCode, appName = config.appName, apiVersion = config.apiVersion, serviceAccount = config.serviceAccount, keyfilePath = config.keyfilePath, keyData = config.keyData, keyId = config.keyId;
